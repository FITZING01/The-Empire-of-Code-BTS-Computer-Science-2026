<?php
// details_commande.php - DETAILED INVOICE (UPDATED 20/04/2026)
include 'db.php';
...
<head>
    <meta charset="UTF-8">
    <title>Invoice <?= $cmd['num_facture'] ?></title>
    ...
    <div class="container border p-5 shadow-sm">
        <div class="row mb-5">
            <div class="col-6">
                ...
                <p>No. <strong><?= $cmd['num_facture'] ?></strong><br>Date: <?= $cmd['date_cmd'] ?></p>
            </div>
            <div class="col-6 text-end">
                <h4>CLIENT</h4>
                <p><strong><?= $cmd['nom_cli'] ?></strong> (<?= $cmd['code_cli'] ?>)<br>City: <?= $cmd['ville_cli'] ?><br>Tel: <?= $cmd['tel_cli'] ?></p>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            <thead class="table-light">
                <tr>
                    <th>Ref.</th>
                    <th>Designation</th>
                    <th class="text-end">Unit Price (FCFA)</th>
            ...
            <tfoot>
                <tr>
                    <th colspan="4" class="text-end h4">GRAND TOTAL</th>
                    <th class="text-end text-danger h4"><?= number_format($total, 0, ',', ' ') ?> FCFA</th>
                </tr>
            </tfoot>
        </table>
        <a href="index.php" class="btn btn-secondary d-print-none mt-4">Back to Dashboard</a>
    </div>
</body>
</html>