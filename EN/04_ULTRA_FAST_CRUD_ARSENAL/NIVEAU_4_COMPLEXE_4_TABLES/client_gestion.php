<?php
// client_gestion.php - COMPLETE CRUD (UPDATED 20/04/2026)
include 'db.php';
...
<head>
    <meta charset="UTF-8">
    <title>Client Management - Level 4</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow border-0">
                    <div class="card-header bg-success text-white py-3"><h5 class="mb-0">Add a Client</h5></div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                <label class="form-label">Company Name</label>
                                <input type="text" name="nom" class="form-control" placeholder="Ex: My Company SAS" required>
                            </div>
                            <button type="submit" name="ajouter" class="btn btn-primary w-100">Save</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="?delete=<?= $c['id_cli'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Delete this client?')">Delete</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
