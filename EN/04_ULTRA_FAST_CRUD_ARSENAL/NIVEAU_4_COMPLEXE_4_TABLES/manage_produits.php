...
<head>
    <meta charset="UTF-8">
    <title>Manage Products - Level 4</title>
            ...
            <div class="col-md-4">
                <div class="card p-4 shadow-sm mb-4 border-0">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            <input type="number" step="0.01" name="prix" class="form-control" placeholder="Price" required>
                        </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-0">
                        <table class="table table-striped mb-0">
                            <thead class="table-dark"><tr><th>ID</th><th>Designation</th><th>Price</th><th class="text-end">Action</th></tr></thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><a href="?del=<?= $p['id_prod'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Delete?')">Delete</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
