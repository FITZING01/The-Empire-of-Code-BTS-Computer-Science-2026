...
<head>
    <meta charset="UTF-8">
    <title>Manage Students - Level 3</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card p-4 shadow-sm mb-4 border-0">
                    <h4 class="mb-3">Add a Student</h4>
                    <form method="POST">
                        <div class="mb-3">
                            <input type="text" name="nom" class="form-control" placeholder="Student name" required>
                        </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-0">
                        <table class="table table-bordered mb-0">
                            <thead class="table-light"><tr><th>ID</th><th>Name</th><th class="text-end">Action</th></tr></thead>
                            <tbody>
                                <?php foreach($etudiants as $e): ?>
                                <tr>
                                    <td><?= $e['id_etu'] ?></td>
                                    <td class="fw-bold"><?= $e['nom_etu'] ?></td>
                                    <td class="text-end"><a href="?del=<?= $e['id_etu'] ?>" class="btn btn-outline-danger btn-sm">Delete</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
