<?php
// commande_gestion.php - GESTION ENTETES (MAJ 20/04/2026)
include 'db.php';
...
<head>
    <meta charset="UTF-8">
    <title>Gestion Commandes - Niveau 4</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="commande_gestion.php">Commandes</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow border-0">
                    <div class="card-header bg-success text-white py-3"><h5 class="mb-0">Créer une Commande</h5></div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <button type="submit" name="creer" class="btn btn-primary w-100 fw-bold">Créer l'entête</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $c['date_cmd'] ?></td>
                                    <td class="text-end">
                                        <a href="ligne_commande_gestion.php?id_cmd=<?= $c['id_cmd'] ?>" class="btn btn-success btn-sm">Articles</a>
                                        <a href="?delete=<?= $c['id_cmd'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Supprimer ?')">X</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
