...
<head>
    <meta charset="UTF-8">
    <title>Gérer Clients - Niveau 4</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card p-4 shadow-sm mb-4 border-0">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            <input type="text" name="nom" class="form-control" placeholder="Nom Entreprise" required>
                        </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-0">
                        <table class="table table-striped mb-0">
                            <thead class="table-dark"><tr><th>ID</th><th>Nom</th><th class="text-end">Action</th></tr></thead>
                            <tbody>
                                <?php foreach($clients as $c): ?>
                                <tr>
                                    <td><?= $c['id_cli'] ?></td>
                                    <td class="fw-bold"><?= $c['nom_cli'] ?></td>
                                    <td class="text-end"><a href="?del=<?= $c['id_cli'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Supprimer ?')">Supprimer</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
