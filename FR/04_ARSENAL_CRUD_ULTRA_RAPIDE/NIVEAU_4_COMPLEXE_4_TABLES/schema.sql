-- ==============================================================================
-- NIVEAU 4 : ERP E-COMMERCE (4 TABLES) - VERSION RÉALITÉ MÉTIER
-- ==============================================================================
DROP DATABASE IF EXISTS bts_niveau4;
CREATE DATABASE bts_niveau4;
USE bts_niveau4;

-- 1. Table Client (Référentiel local)
CREATE TABLE client (
...
-- 2. Table Produit (Stock avec références)
...
-- 3. Table Commande (Entêtes de facturation)
...
-- 4. Table LigneCommande (Détails panier)
