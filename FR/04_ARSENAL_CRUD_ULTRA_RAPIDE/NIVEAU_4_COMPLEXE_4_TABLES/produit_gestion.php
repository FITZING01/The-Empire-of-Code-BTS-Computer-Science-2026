...
<head>
    <meta charset="UTF-8">
    <title>Gestion Produits - Niveau 4</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow border-0">
                    <div class="card-header bg-success text-white py-3"><h5 class="mb-0">Nouveau Produit</h5></div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="prix" class="form-control" placeholder="Prix HT" required>
                            </div>
                            <button type="submit" name="ajouter" class="btn btn-primary w-100 fw-bold">Ajouter au Stock</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="?delete=<?= $p['id_prod'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Retirer du stock ?')">Retirer</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
