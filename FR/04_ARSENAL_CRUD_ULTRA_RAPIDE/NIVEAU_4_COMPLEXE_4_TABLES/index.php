<?php
// index.php - DASHBOARD ERP (MAJ 20/04/2026)
include 'db.php';
// Requête riche : Facture + Client + Ville + Total global
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4 shadow">
    ...
    <div class="navbar-nav">
        ...
        <a class="nav-link" href="commande_gestion.php">Facturation</a>
    </div></div>
</nav>

<div class="container">
    <h2 class="mb-4 text-secondary">Tableau de Bord des Ventes</h2>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="details_commande.php?id=<?= $cmd['id_cmd'] ?>" class="btn btn-sm btn-outline-info">Consulter</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
