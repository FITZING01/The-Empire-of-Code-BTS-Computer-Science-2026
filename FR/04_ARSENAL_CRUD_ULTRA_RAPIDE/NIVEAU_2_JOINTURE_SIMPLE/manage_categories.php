<?php
// manage_categories.php - MAJ 20/04/2026
include 'db.php';
...
<html>
<head>
    <title>Catégories - Niveau 2</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">Ajout Rapide</div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                <input type="text" name="libelle" class="form-control" placeholder="Nouvelle catégorie" required>
                            </div>
