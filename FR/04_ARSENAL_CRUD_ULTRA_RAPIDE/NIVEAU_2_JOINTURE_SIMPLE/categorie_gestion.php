<?php
// categorie_gestion.php - CRUD COMPLET (MAJ 20/04/2026)
include 'db.php';
...
<head>
    <meta charset="UTF-8">
    <title>Gestion des Catégories - Niveau 2</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="categorie_gestion.php">Catégories</a></li>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" class="d-flex gap-2">
                            <input type="text" name="libelle" class="form-control" placeholder="Nom de la catégorie" required>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $c['libelle'] ?></td>
                                    <td class="text-end">
                                        <a href="?delete=<?= $c['id_cat'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Supprimer ?')">Supprimer</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
