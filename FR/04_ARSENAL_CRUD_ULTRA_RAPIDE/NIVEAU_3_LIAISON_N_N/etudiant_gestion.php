<?php
// etudiant_gestion.php - CRUD COMPLET (MAJ 20/04/2026)
include 'db.php';
...
<head>
    <meta charset="UTF-8">
    <title>Gestion Étudiants - Niveau 3</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow border-0">
                    <div class="card-header bg-warning py-3"><h5 class="mb-0">Ajouter un Étudiant</h5></div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="?delete=<?= $e['id_etu'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Supprimer cet étudiant ?')">Supprimer</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
