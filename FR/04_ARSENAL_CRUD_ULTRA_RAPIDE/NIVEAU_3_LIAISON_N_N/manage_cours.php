...
<head>
    <meta charset="UTF-8">
    <title>Gérer Cours - Niveau 3</title>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card p-4 shadow-sm mb-4 border-0">
                    <h4 class="mb-3">Ajouter un Cours</h4>
                    <form method="POST">
                        <div class="mb-3">
                            <input type="text" name="titre" class="form-control" placeholder="Titre du cours" required>
                        </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-0">
                        <table class="table table-bordered mb-0">
                            <thead class="table-light"><tr><th>ID</th><th>Titre</th><th class="text-end">Action</th></tr></thead>
                            <tbody>
                                <?php foreach($cours as $c): ?>
                                <tr>
                                    <td><?= $c['id_cours'] ?></td>
                                    <td class="fw-bold"><?= $c['titre_cours'] ?></td>
                                    <td class="text-end"><a href="?del=<?= $c['id_cours'] ?>" class="btn btn-outline-danger btn-sm">Supprimer</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
